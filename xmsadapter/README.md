# This document provides brief instructions for Android Library SDK developers.
...
RemoteConfig        com.google.android.gms:play-services-base:17.1.0
                    com.huawei.hms:base:5.0.0.300
                    com.google.android.gms:play-services-basement:17.1.0
                    com.google.firebase:firebase-config:19.1.3
                    com.huawei.agconnect:agconnect-remoteconfig:1.4.0.300
...
6. SDK Release Guide
For Android Library SDK developers, use the generated code in the same way as using GMS code. When packaging, don't put the generated code into the lib package. Otherwise, it will conflict with the app developer's source code.
We provide the following release templates to help supplement your release instructions.

# Template for your user manual
Add the SDK to your project
If you are using the Maven repository, add the following to your build.gradle file:
{your sdk dependency}

Add Google Play Services
To enable GMS in our SDK, you must integrate Google Play Services. If you haven't done this yet, add the dependency of the Google Play Services library to the "dependencies" block in your app's build.gradle file:
{your dependency of GMS}

# Template for integration with Huawei Mobile Service
Integrate both GMS and HMS
For app developer, if you are integrating GMS and HMS in one app, you will need to call the generated SDK when developing your SDK {SDK-name}. 
The method below is provided for you to generate code using HMS ToolKit. (For more information, please visit the following URL: https://developer.huawei.com/consumer/en/doc/development/Tools-Guides/05673260
Method 1:
1. Add the GMS dependencies to the dependencies block of your app's build.gradle file.
2. Use HMS Convertor to start a new conversion. (For more information, please visit the following URL: https://developer.huawei.com/consumer/en/doc/development/Tools-Guides/90419706
