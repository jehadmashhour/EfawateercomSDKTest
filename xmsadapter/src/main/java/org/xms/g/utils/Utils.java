...
public class Utils {
    ...
    static {
        ...
        map.put("com.google.firebase.remoteconfig.FirebaseRemoteConfig", "org.xms.f.remoteconfig.ExtensionRemoteConfig");
        map.put("com.huawei.agconnect.remoteconfig.AGConnectConfig", "org.xms.f.remoteconfig.ExtensionRemoteConfig");
        map.put("com.google.firebase.remoteconfig.FirebaseRemoteConfigClientException", "org.xms.f.remoteconfig.ExtensionRemoteConfigClientException");
        map.put("com.google.firebase.remoteconfig.FirebaseRemoteConfigException", "org.xms.f.remoteconfig.ExtensionRemoteConfigException");
        map.put("com.google.firebase.remoteconfig.FirebaseRemoteConfigFetchException", "org.xms.f.remoteconfig.ExtensionRemoteConfigFetchException");
        map.put("com.google.firebase.remoteconfig.FirebaseRemoteConfigFetchThrottledException", "org.xms.f.remoteconfig.ExtensionRemoteConfigFetchThrottledException");
        map.put("com.google.firebase.remoteconfig.FirebaseRemoteConfigInfo", "org.xms.f.remoteconfig.ExtensionRemoteConfigInfo$XImpl");
        map.put("com.google.firebase.remoteconfig.FirebaseRemoteConfigServerException", "org.xms.f.remoteconfig.ExtensionRemoteConfigServerException");
        map.put("com.huawei.agconnect.remoteconfig.AGCConfigException", "org.xms.f.remoteconfig.ExtensionRemoteConfigServerException");
        map.put("com.google.firebase.remoteconfig.FirebaseRemoteConfigSettings", "org.xms.f.remoteconfig.ExtensionRemoteConfigSettings");
        map.put("com.google.firebase.remoteconfig.FirebaseRemoteConfigSettings.Builder", "org.xms.f.remoteconfig.ExtensionRemoteConfigSettings$Builder");
        map.put("com.google.firebase.remoteconfig.FirebaseRemoteConfigValue", "org.xms.f.remoteconfig.ExtensionRemoteConfigValue$XImpl");
